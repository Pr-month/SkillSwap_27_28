...
import { IsEmail, IsEnum, IsOptional, IsString, Length, MinLength, IsDateString } from 'class-validator';
...
export class RegisterDto {
  ...
  @ApiProperty({ example: 'Информация о себе...', description: 'О себе', required: false })
  @IsOptional()
  @IsString()
  @Length(0, 500, { message: 'Информация о себе не должна превышать 500 символов' })
  about?: string;

  @ApiProperty({ example: '1990-01-01', description: 'Дата рождения', required: false })
  @IsOptional()
  ...
  @ApiProperty({ enum: Gender, example: Gender.MALE, description: 'Пол', required: false })
  @IsOptional()
  @IsEnum(Gender)
  gender?: Gender;
